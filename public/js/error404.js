...
animate(); 
 ...
 function verificarPagina(url, callback) {
...
// Función para redirigir a la página de error 404 personalizada
function redirigirA404() {
    window.location.href = '/error'; // Asegúrate de que esta ruta sea correcta
}

// Verifica si la página existe antes de intentar acceder a ella
verificarPagina('/error', function(existe) {
    if (!existe) {
        redirigirA404();
    }
});
