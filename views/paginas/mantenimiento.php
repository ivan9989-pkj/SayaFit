    ...
    <div class="sect sect--padding-top">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="site">
                        <h1 class="site__title">Estamos mejorando nuestra página para ti.</h1>
                        <h2 class="site__subtitle">Disculpa las molestias.</h2>
                        <img class="site__img" src="https://www.web-leb.com/assets/img/ess.png">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
                <div class="col-md-10 col-xs-6">
                    <div class="footer__social">
                        <a href="#" class="footer__social-l"><i class="fa-brands fa-instagram"></i></a>
